...
skecth=quick_draw_data_set[random_no]

document.getElementById("rooprekha_v2").innerHTML="Pls draw I beg u 😢"+skecth
...
checksketch()
if(drawn_sketch==skecth){
    answer_holder="set"
    score=score+1
    document.getElementById("ank").innerHTML="Score: "+score
}
else{document.getElementById("ank").innerHTML="Score: 0"}
}
...
document.getElementById("rooprekha").innerHTML="You Drew: "+drawn_sketch
document.getElementById("vishwas").innerHTML="Accuracy: "+results[0].confidence
    }
}
...
function updateCanvas(){
  ...
  document.getElementById('rooprekha_v2').innerHTML = 'Sketch To be Drawn: ' + skecth;

}

function  checksketch(){
timer_counter++
document.getElementById("Samay").innerHTML="Time: "+timer_counter
